...
function bones_scripts_and_styles() {
	...
	if (!is_admin()) {
		...
		wp_register_script( 'angular-animate', '//code.angularjs.org/1.3.12/angular-animate.js', array('angular'), '', false );



		wp_register_script( 'benson-app', get_stylesheet_directory_uri() . '/library/angular/app.js', array('angular','angular-animate'), '', true );
...
function bones_main_nav() {
	...
	wp_nav_menu(array(
		...
		'menu_class' => 'nav main-nav wrap clearfix',         // adding custom nav class
...
function bones_top_nav() {
	...
	wp_nav_menu(array(
		...
		'menu_class' => 'nav top-nav wrap clearfix gradient',         // adding custom nav class
...
function bones_footer_links() {
	...
	wp_nav_menu(array(
		...
		'menu_class' => 'nav footer-nav clearfix gradient',      // adding custom nav class
