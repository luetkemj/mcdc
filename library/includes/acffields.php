...
register_field_group(array (
  ...
  'fields' => array (
    ...
    array (
      'key' => 'field_54f73ab9199bf',
      'label' => 'wpjson_url',
      'name' => 'wpjson_url',
      'prefix' => '',
      'type' => 'text',
      'instructions' => 'Paste your wpjson endpoint here',
      'required' => 0,
      'conditional_logic' => 0,
      'wrapper' => array (
        'width' => '',
...
register_field_group(array (
  'key' => 'group_54f4b1708408d',
  'title' => 'Resource Meta',
  'fields' => array (
    array (
      'key' => 'field_54f4b17f285de',
      'label' => 'External Link',
      'name' => 'external_link',
      'prefix' => '',
      'type' => 'url',
    ...
    array (
      'key' => 'field_54f4b1d3285e0',
      'label' => 'Content Owner',
      'name' => 'content_owner',
      'prefix' => '',
      'type' => 'checkbox',
      'instructions' => 'Check MC if the content was made by Making Comics.',
      'required' => 0,
      'conditional_logic' => 0,
      'wrapper' => array (
        'width' => '',
    ...
    array (
      'key' => 'field_54f7584b153aa',
      'label' => 'Cost',
      'name' => 'cost',
      'prefix' => '',
      'type' => 'checkbox',
      'instructions' => 'Check $ if this content costs money.',
      'required' => 0,
      'conditional_logic' => 0,
      'wrapper' => array (
        'width' => '',
    ...
    array (
      ...
      'default_value' => array (
        'Check the Priority level of this content. 1 is highest.' => 'Check the Priority level of this content. 1 is highest.',
      ),
      'layout' => 'vertical',
    ),
  ),
